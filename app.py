"""Streamlit demo application for AI-assisted workflow authoring."""
...
# Page config
st.set_page_config(
    page_title="AI Workflow Authoring",
    page_icon="🔄",
    layout="wide",
    ...
    with col_progress:
        with st.status("🔄 Processing workflow...", expanded=True) as status:
            ...
            if state.error_message:
                ...
                # NOTE: Diagram tab updated only after pipeline completes successfully
